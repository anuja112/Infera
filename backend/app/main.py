...
def _check_index_consistency() -> None:
    ...
    if missing:
        logger.warning("%d chunks have no vector and cannot be found by meaning. Delete and re-upload the affected documents.", missing)
...
app = FastAPI(
    title="Document Intelligence & Retrieval Platform",
