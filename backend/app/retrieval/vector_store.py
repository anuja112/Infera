...
class VectorStore:
    ...
    def search(
        ...
        """Return up to k (chunk_id, cosine_similarity) pairs, best first.If `allowed_ids` is given, FAISS only considers those ids (filter BEFORE ranking).
        """
        with self._lock:
            ...
            if allowed_ids is not None:
                ...
                params.sel = selector                     # keep `selector` referenced until search ends
